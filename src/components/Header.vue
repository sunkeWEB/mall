<template>
    <header class="header">
        ...
        <div class="navbar">
            ...
            <div class="navbar-right-container" style="display: flex;">
                <div class="navbar-menu-container">
                    ...
                    <span v-text="nickname" v-if="nickname" style="padding-right: 10px"></span>
                    <a href="javascript:void(0)" class="navbar-link" @click="showLogin=!showLogin" v-if="!nickname"
                       style="padding-right: 10px">Login</a>
                    <a href="javascript:void(0)" class="navbar-link" v-if="nickname" style="padding-right: 10px"
                       @click="logout">Logout</a>
                    <div class="navbar-cart-container 111">
        ...
        <div class="md-modal modal-msg md-modal-transition" :class="{'md-show':showLogin}">
            <div class="md-modal-inner">
                <div class="md-top">
                    ...
                    <button class="md-close" @click="showLogin=!showLogin">Close</button>
                </div>
                <div class="md-content">
                    <div class="confirm-tips">
                        <div class="error-warp">
                            <span class="error error-show" v-if="errorTip">用户名或账号错误</span>
                        </div>
                        <ul>
                            ...
                            <li class="regi_form_input noMargin">
                                ...
                                <input type="password" tabindex="2" name="password" v-model="userPwd" placeholder="密码"
        ...
        <div :class="{'md-overlay':showLogin}"></div>
    </header>
</template>
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods: {
            checkLogin () {
                axios.get('/checkLogin').then((responens)=>{
                    let res = responens.data;
                    if (res.status=='0') {
            ...
            logout () {
                axios.post('/logout').then((respone) => {
